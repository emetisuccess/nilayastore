        ...
        <div class="col-md-12">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $data['product_title']; ?>" name="product_title"
                        class="form-control">
                </div>
                <div class="form-group">
                    <label for="product_description">Product Description</label>
                    <textarea type="text" rows="5" name="product_description"
                        class="form-control"><?php echo $data['product_description']; ?></textarea>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="product_price">Product Price</label>
                            <input type="text" value="<?php echo $data['product_price']; ?>" name="product_price"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="product_quantity">Product Quantity</label>
                            <input type="number" value="<?php echo $data['product_quantity']; ?>"
                                name="product_quantity" min="1" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            <aside id='admin_sidebar' class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" rows="5" name="product_keywords"
                        class="form-control"><?php echo $data['product_keywords']; ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <img src="../../resources/uploads/<?php echo $data['product_image']; ?>" height="100px"
                        width="100px">
